...
def main():
    ...
    pprint([name for i, name in enumerate(model_name_list) if norm_mls_list[i]<20000 and sharpness_list[i]>6000])
    pprint([name for i, name in enumerate(model_name_list) if norm_mls_list[i]>80000 and sharpness_list[i]<2000])
